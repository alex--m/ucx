                             ...
                             ucp_mt_type_t mt_type)
{
    ...
    if (params->field_mask & UCP_PARAM_FIELD_GROUP_PEER_INFO) {
        context->config.num_local_peers = params->peer_info.num_local;
        context->config.my_local_peer_idx  = params->peer_info.local_idx;
        context->config.num_global_peers = params->peer_info.num_global;
        context->config.my_global_peer_idx  = params->peer_info.global_idx;
    } else {
